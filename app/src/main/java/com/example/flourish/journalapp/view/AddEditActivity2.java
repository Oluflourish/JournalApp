...
public class AddEditActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (noteId == -1 && action == NOTE_ACTION_ADD) {
            ...
            startActivity(new Intent(AddEditActivity2.this, MainActivity.class));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_save:
                ...
                Intent intent = new Intent(AddEditActivity2.this, MainActivity.class);
